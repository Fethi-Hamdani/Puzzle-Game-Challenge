...
import 'package:flutter_game_challenge/hud/game_over/game_over_screen.dart';
...
import 'package:flutter_game_challenge/hud/player_info/player_info.dart';
...
Map<String, Widget Function(BuildContext, PlaneGame)> gameHud = {
  ...
  GameOverlay.playerInfo.name: (context, game) => PlayerInfoScreen(game: game),
